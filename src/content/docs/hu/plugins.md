...
description: Áttekintés a Racona alkalmazás rendszeréről – hogyan működnek az alkalmazások, mik a különbségek a beépített alkalmazásokhoz képest
---

## Mi az a alkalmazás?

A Racona kétféle alkalmazást ismer:
...
Ha **saját alkalmazást** szeretnél a Racona-be integrálni és hozzáférsz a monorepo-hoz, a beépített alkalmazás a megfelelő választás — teljes SvelteKit hozzáféréssel, Drizzle ORM-mel, server action-ökkel.
