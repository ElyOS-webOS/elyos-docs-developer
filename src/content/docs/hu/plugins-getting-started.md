...
- Futó Racona példány (Docker-rel vagy lokálisan) — szükséges az alkalmazás feltöltéséhez és a Racona rendszeren belüli teszteléséhez (nem csak standalone módban). Lásd: [Docker-alapú futtatás](/hu/getting-started#docker-alapú-futtatás)
